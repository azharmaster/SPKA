                ...
                <div class="row">
                  <div class="col-sm-4 col-6">
                    <div class="description-block border-right ">
                      ...
                      <span class="description-text">Real Fire </span></h5>
                  ...
                  <div class="col-sm-4 col-6">
                    <div class="description-block border-right">
                      ...
                      <span class="description-text">Alarm </span></h5>
                  ...
                  <div class="col-sm-4 col-6">
                    <div class="description-block ">
                      ...
                      <span class="description-text">False Alarm </span></h5>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
...
<script src="file/plugins/chart.js/Chart.min.js"></script>
  ...
  const data = {
    ...
    datasets: [{
      ...
      backgroundColor: ['#f56954', '#00a65a', '#f39c12'], // Colors matching legend
      hoverOffset: 4
    }]
  };
...
<script>
    ...
    const fireData = [
      { negeri: 'Johor', coord: [1.4854, 103.7618], jumlah: 10 },
      { negeri: 'Kedah', coord: [6.1184, 100.3686], jumlah: 5 },
      { negeri: 'Kelantan', coord: [6.1254, 102.2381], jumlah: 7 },
      { negeri: 'Melaka', coord: [2.1896, 102.2501], jumlah: 3 },
      { negeri: 'Negeri Sembilan', coord: [2.7258, 101.9424], jumlah: 4 },
      { negeri: 'Pahang', coord: [3.8126, 103.3256], jumlah: 8 },
      { negeri: 'Penang', coord: [5.4141, 100.3288], jumlah: 6 },
      { negeri: 'Perak', coord: [4.5921, 101.0901], jumlah: 9 },
      { negeri: 'Perlis', coord: [6.4448, 100.2043], jumlah: 2 },
      { negeri: 'Sabah', coord: [5.9788, 116.0753], jumlah: 12 },
      { negeri: 'Sarawak', coord: [1.5533, 110.3592], jumlah: 15 },
      { negeri: 'Selangor', coord: [3.0738, 101.5183], jumlah: 11 },
      { negeri: 'Terengganu', coord: [5.3117, 103.1324], jumlah: 7 },
    ];
    ...
    fireData.forEach(data => {
      ...
      L.marker(data.coord, { icon: fireIcon })
        .addTo(map)
