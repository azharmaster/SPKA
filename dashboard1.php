...
<body class="hold-transition dark-mode  layout-fixed   text-sm sidebar-collapse">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-body -->
                                <div class="card-footer" style="background: linear-gradient(to right, rgba(255, 61, 90, 0.8), rgba(255, 239, 186, 0.8), rgba(124, 255, 153, 0.8));
    color: white; ">
                                    <div class="row">
    ...
    <script>
        ...
        gradient.addColorStop(0, 'rgba(54, 162, 235, 1)'); // Biru gelap
        gradient.addColorStop(1, 'rgba(173, 216, 230, 1)'); // Biru muda (light blue)

        // Data untuk graf jumlah alarm setiap bulan
        const data2 = {
            labels: ['Januari', 'Februari', 'Mac', 'April', 'Mei', 'Jun', 'Julai', 'Ogos', 'September', 'Oktober',
                'November', 'Disember'
            ],
            datasets: [{
                label: 'Jumlah Alarm',
                data: [12, 18, 9, 14, 20, 22, 15, 30, 25, 28, 19, 16], // Gantikan dengan data sebenar
                backgroundColor: gradient, // Menggunakan gradient warna biru ke biru muda
